...
Page({
  ...
  send: function(){
    ...
    const requestTask = wx.request({
      url: 'https://api.heclouds.com/devices/642667304/datapoints?datastream_id=Humidity&limit=15',
      header: {
        'content-type': 'application/json',
        'api-key': 'JuKWP1HC8fquXZJ8Wiu=uzHUNBo='
      },
	...
	//温度高于设置的门限值
        if (res.data.data.datastreams[0] > that.data.threshold) {
  ...
  getDataFromOneNet: function(){
    ...
    const requestTask = wx.request({
      url: 'https://api.heclouds.com/devices/642667304/datapoints?datastream_id=Light,Temperature,Humidity&limit=15',
        header: {
        'content-type': 'application/json',
          'api-key': 'JuKWP1HC8fquXZJ8Wiu=uzHUNBo='
      },
